...
<div class="form-page">
    <div class="form-card">
        ...
        <form method="POST" action="proses_edit.php">
            ...
            <div class="mb-3">
                <label class="form-label">Foto Outlet (biarkan jika tidak diubah)</label>
            ...
            <div class="row">
                <div class="col-md-6 mb-3">
                    ...
                    value="<?= $toko['jam_buka']; ?>" required>
                </div>

                <div class="col-md-6 mb-3">
                    <label class="form-label">Jam Tutup</label>
                    <input type="time" name="jam_tutup" class="form-control"
                    value="<?= $toko['jam_tutup']; ?>" required>
                </div>
            </div>
            ...
            <div class="mb-4">
                ...
                <select name="status_halal" class="form-select" required>
                    ...
                    <option value="belum tersertifikasi" <?= $toko['status_halal']=='belum tersertifikasi'?'selected':'' ?>>
